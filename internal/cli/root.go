...
func New() *cobra.Command {
	...
	root.AddCommand(a.listCommand(), a.newCommand(), a.editCommand(), a.removeCommand(), a.connectCommand(), a.forwardCommand(), a.copyCommand(), a.historyCommand(), completionCommand(), versionCommand())
